...
export const ANALYTICS_QUERY_STALE_TIME_MS = 5 * 60 * 1000
...
export const ANALYTICS_PASS_THRESHOLD = 80
export const ACTIVITY_CALENDAR_DAYS = 365
export const STREAK_WIDGET_DAYS = 7
export const BADGES_LAST_CHECK_STORAGE_KEY = 'sdmastery:last-badge-check-time'
